...
function getBot(strType) {
    var theBot;
    var list2 = ['战威','恐龙勇士','战擎','通天晓','红蜘蛛','大黄蜂','狂飙','暗黑擎天柱','碾碎器','猩猩队长','钢锁','斗擎','汽车大师','野牛','惊天雷','雷震','探长','碎骨魔','漂移','阿尔茜','热破','巨蝎勇士','亡灵天尊','挽歌','风刃','路障','小黄蜂','横炮','反冲','警车','爵士','黄豹','声波','震荡波','犀牛','救护车','幻影','录音机','千斤顶','天火','爆威','黄蜂','电影铁皮','喷气机','惊破天','搅拌者','震天尊','飞过山'];
    var list3 = list2;
    var list4 = list2;
    var list5 = ['战威','恐龙勇士','战擎','通天晓','红蜘蛛','狂飙','碾碎器','猩猩队长','钢锁','斗擎','汽车大师','野牛','雷震','探长','碎骨魔','漂移','阿尔茜','热破','巨蝎勇士','挽歌','风刃','路障','横炮','反冲','警车','爵士','黄豹','声波','震荡波','犀牛','救护车','幻影','录音机','千斤顶','天火','爆威','黄蜂','电影铁皮','喷气机','惊破天','搅拌者'];
    var listBee = ['大黄蜂', '小黄蜂'];
    var listNP = ['暗黑擎天柱'];
    var listTC = ['惊天雷'];
